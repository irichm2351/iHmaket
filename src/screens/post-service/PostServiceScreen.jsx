...
const PostServiceScreen = () => {
  ...
  const uniqueLgasByState = Object.fromEntries(
    Object.entries(lgasByState).map(([key, value]) => [key, Array.from(new Set(value))])
  );
  ...
  const handleSubmit = async () => {
    ...
    try {
      setLoading(true);
      setMessage('Posting service... Please wait');
      ...
      if (response.data.success) {
        ...
        setMessage('Failed to post service. Please try again.');
      }
    } catch (error) {
      ...
      if (error.code === 'ECONNABORTED') {
        ...
        setMessage('Unable to post service. Please try again.');
      }
    } finally {
      setLoading(false);
    }
    ...
    >
      ...
      <View style={styles.header}>
        ...
        <View style={{ marginLeft: 12 }}>
          ...
          <Text style={styles.subtitle}>Reach customers ready to book you</Text>
        </View>
      </View>
      ...
      <View style={styles.formCard}>
        ...
        <View style={styles.row}>
          <View style={styles.half}>
            ...
            <TextInput
              style={[styles.input, isNegotiable && styles.disabledInput]}
              placeholder="12000"
